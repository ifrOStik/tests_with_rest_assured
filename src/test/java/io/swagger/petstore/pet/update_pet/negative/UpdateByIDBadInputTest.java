...
@Story("Bad request for update pet by ID")
@DisplayName("Bad request for update pet by ID")
public class UpdateByIDBadInputTest extends PetDataGenerator{

    @Test
    @DisplayName("Test : Bad request for update pet by ID")
    @Description("Bad request for update pet by ID and check that response will be 400 error")
    public void test() {
        ...
        BadResponse actualPetResponse = petController.updateByIdBadRequest(pet);
