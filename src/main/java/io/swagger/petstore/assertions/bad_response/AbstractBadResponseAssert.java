...
public abstract class AbstractBadResponseAssert<S extends AbstractBadResponseAssert<S, A>, A extends BadResponse> extends AbstractObjectAssert<S, A> {

  /**
   * Creates a new <code>{@link AbstractBadResponseAssert}</code> to make assertions on actual BadResponse.
   * @param actual the BadResponse we want to make assertions on.
   */
  protected AbstractBadResponseAssert(A actual, Class<S> selfType) {
